...
#define MAX_Q_VECTORS		4

#define MNIC_MAX_TX_QUEUES	2	
#define MNIC_MAX_RX_QUEUES	2
#define MAX_MSIX_ENTRIES	4
...
struct mnic_bar4
{	
	uint64_t rx_desc_base[MNIC_MAX_RX_QUEUES];
	uint64_t rx_desc_tail[MNIC_MAX_RX_QUEUES];
	struct descriptor tx_pkt[MNIC_MAX_TX_QUEUES];
}__attribute__((packed));
